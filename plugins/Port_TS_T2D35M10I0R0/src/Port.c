...
/**
* @violates @ref PORT_C_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to
...
/**
* @violates @ref PORT_C_REF_2 Violates MISRA 2004 Required Rule 19.15, Repeated include file 
*                MemMap.h
*/
...
/** @violates @ref PORT_C_REF_4 MISRA 2004 Required Rule 8.10, All declarations and definitions of 
...
/**
* @violates @ref PORT_C_REF_1 Violates MISRA 2004 Advisory Rule 19.1, Only preprocessor statements 
