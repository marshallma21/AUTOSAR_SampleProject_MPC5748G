...
#error "Software Version Numbers of Icu_Ipw_Types.h and Icu_Types.h are different"
 ...
 /* Check if Icu_Ipw_Types header and Icu_eMios_Types file are of the same vendor */
#if (ICU_IPW_TYPES_VENDOR_ID != ICU_EMIOS_TYPES_VENDOR_ID)
    #error "Icu_Ipw_Types.h and Icu_eMIOS.h have different vendor IDs"
#endif
    /* Check if header file and Icu_eMios_Types file are of the same Autosar version */
#if ((ICU_IPW_TYPES_AR_RELEASE_MAJOR_VERSION != ICU_EMIOS_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (ICU_IPW_TYPES_AR_RELEASE_MINOR_VERSION != ICU_EMIOS_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (ICU_IPW_TYPES_AR_RELEASE_REVISION_VERSION != ICU_EMIOS_TYPES_AR_RELEASE_REVISION_VERSION))
 #error "AutoSar Version Numbers of Icu_Ipw_Types.h and Icu_eMios_Types.h are different"
#endif
/* Check if header file and Icu_eMios_Types file are of the same software version */
#if ((ICU_IPW_TYPES_SW_MAJOR_VERSION != ICU_EMIOS_TYPES_SW_MAJOR_VERSION) || \
     (ICU_IPW_TYPES_SW_MINOR_VERSION != ICU_EMIOS_TYPES_SW_MINOR_VERSION) || \
     (ICU_IPW_TYPES_SW_PATCH_VERSION != ICU_EMIOS_TYPES_SW_PATCH_VERSION))
 #error "Software Version Numbers of Icu_Ipw_Types.h and Icu_eMios_Types.h are different"
#endif


/* Check if Icu_Ipw_Types header and Icu_Siul2_Types file are of the same vendor */
#if (ICU_IPW_TYPES_VENDOR_ID != ICU_SIUL2_TYPES_VENDOR_ID)
    #error "Icu_Ipw_Types.h and Icu_Siul2_Types.h have different vendor IDs"
#endif
    /* Check if header file and Icu_Siul2_Types file are of the same Autosar version */
#if ((ICU_IPW_TYPES_AR_RELEASE_MAJOR_VERSION != ICU_SIUL2_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (ICU_IPW_TYPES_AR_RELEASE_MINOR_VERSION != ICU_SIUL2_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (ICU_IPW_TYPES_AR_RELEASE_REVISION_VERSION != ICU_SIUL2_TYPES_AR_RELEASE_REVISION_VERSION))
 #error "AutoSar Version Numbers of Icu_Ipw_Types.h and Icu_Siul2_Types.h are different"
#endif
/* Check if header file and Icu_Siul2_Types file are of the same software version */
#if ((ICU_IPW_TYPES_SW_MAJOR_VERSION != ICU_SIUL2_TYPES_SW_MAJOR_VERSION) || \
     (ICU_IPW_TYPES_SW_MINOR_VERSION != ICU_SIUL2_TYPES_SW_MINOR_VERSION) || \
     (ICU_IPW_TYPES_SW_PATCH_VERSION != ICU_SIUL2_TYPES_SW_PATCH_VERSION))
 #error "Software Version Numbers of Icu_Ipw_Types.h and Icu_Siul2_Types.h are different"
#endif


/* Check if Icu_Ipw_Types header and Icu_Wkpu_Types file are of the same vendor */
#if (ICU_IPW_TYPES_VENDOR_ID != ICU_WKPU_TYPES_VENDOR_ID)
    #error "Icu_Ipw_Types.h and Icu_Wkpu_Types.h have different vendor IDs"
#endif
    /* Check if header file and Icu_Wkpu_Types file are of the same Autosar version */
#if ((ICU_IPW_TYPES_AR_RELEASE_MAJOR_VERSION != ICU_WKPU_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (ICU_IPW_TYPES_AR_RELEASE_MINOR_VERSION != ICU_WKPU_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (ICU_IPW_TYPES_AR_RELEASE_REVISION_VERSION != ICU_WKPU_TYPES_AR_RELEASE_REVISION_VERSION))
 #error "AutoSar Version Numbers of Icu_Ipw_Types.h and Icu_Wkpu_Types.h are different"
#endif
/* Check if header file and Icu_Wkpu_Types file are of the same software version */
#if ((ICU_IPW_TYPES_SW_MAJOR_VERSION != ICU_WKPU_TYPES_SW_MAJOR_VERSION) || \
     (ICU_IPW_TYPES_SW_MINOR_VERSION != ICU_WKPU_TYPES_SW_MINOR_VERSION) || \
     (ICU_IPW_TYPES_SW_PATCH_VERSION != ICU_WKPU_TYPES_SW_PATCH_VERSION))
 #error "Software Version Numbers of Icu_Ipw_Types.h and Icu_Wkpu_Types.h are different"
#endif
...
#define ICU_EMIOS_CHANNEL         ((Icu_ChannelIpType)0)

/** @brief Symbolic name for Siul2 channels */
#define ICU_SIUL2_CHANNEL         ((Icu_ChannelIpType)1)

/** @brief Symbolic name for Wkpu channels */
#define ICU_WKPU_CHANNEL          ((Icu_ChannelIpType)2)

/* Macros to name the HW channels (eMIOS and IRQ's) */
/**
* @{
* @brief      eMIOS Channelss
...
#define ICU_EMIOS_0_MAX         (ICU_EMIOS_0_CH_0 + 31U)

#define ICU_EMIOS_1_CH_0        (ICU_EMIOS_0_MAX  +  1U)
...
#define ICU_EMIOS_1_MAX         (ICU_EMIOS_1_CH_0 + 31U)

#define ICU_EMIOS_2_CH_0        (ICU_EMIOS_1_MAX  +  1U)
#define ICU_EMIOS_2_CH_1        (ICU_EMIOS_2_CH_0 +  1U)
#define ICU_EMIOS_2_CH_2        (ICU_EMIOS_2_CH_0 +  2U)
#define ICU_EMIOS_2_CH_3        (ICU_EMIOS_2_CH_0 +  3U)
#define ICU_EMIOS_2_CH_4        (ICU_EMIOS_2_CH_0 +  4U)
#define ICU_EMIOS_2_CH_5        (ICU_EMIOS_2_CH_0 +  5U)
#define ICU_EMIOS_2_CH_6        (ICU_EMIOS_2_CH_0 +  6U)
#define ICU_EMIOS_2_CH_7        (ICU_EMIOS_2_CH_0 +  7U)
#define ICU_EMIOS_2_CH_8        (ICU_EMIOS_2_CH_0 +  8U)
#define ICU_EMIOS_2_CH_9        (ICU_EMIOS_2_CH_0 +  9U)
#define ICU_EMIOS_2_CH_10       (ICU_EMIOS_2_CH_0 + 10U)
#define ICU_EMIOS_2_CH_11       (ICU_EMIOS_2_CH_0 + 11U)
#define ICU_EMIOS_2_CH_12       (ICU_EMIOS_2_CH_0 + 12U)
#define ICU_EMIOS_2_CH_13       (ICU_EMIOS_2_CH_0 + 13U)
#define ICU_EMIOS_2_CH_14       (ICU_EMIOS_2_CH_0 + 14U)
#define ICU_EMIOS_2_CH_15       (ICU_EMIOS_2_CH_0 + 15U)
#define ICU_EMIOS_2_CH_16       (ICU_EMIOS_2_CH_0 + 16U)
#define ICU_EMIOS_2_CH_17       (ICU_EMIOS_2_CH_0 + 17U)
#define ICU_EMIOS_2_CH_18       (ICU_EMIOS_2_CH_0 + 18U)
#define ICU_EMIOS_2_CH_19       (ICU_EMIOS_2_CH_0 + 19U)
#define ICU_EMIOS_2_CH_20       (ICU_EMIOS_2_CH_0 + 20U)
#define ICU_EMIOS_2_CH_21       (ICU_EMIOS_2_CH_0 + 21U)
#define ICU_EMIOS_2_CH_22       (ICU_EMIOS_2_CH_0 + 22U)
#define ICU_EMIOS_2_CH_23       (ICU_EMIOS_2_CH_0 + 23U)
#define ICU_EMIOS_2_CH_24       (ICU_EMIOS_2_CH_0 + 24U)
#define ICU_EMIOS_2_CH_25       (ICU_EMIOS_2_CH_0 + 25U)
#define ICU_EMIOS_2_CH_26       (ICU_EMIOS_2_CH_0 + 26U)
#define ICU_EMIOS_2_CH_27       (ICU_EMIOS_2_CH_0 + 27U)
#define ICU_EMIOS_2_CH_28       (ICU_EMIOS_2_CH_0 + 28U)
#define ICU_EMIOS_2_CH_29       (ICU_EMIOS_2_CH_0 + 29U)
#define ICU_EMIOS_2_CH_30       (ICU_EMIOS_2_CH_0 + 30U)
#define ICU_EMIOS_2_CH_31       (ICU_EMIOS_2_CH_0 + 31U)

#define ICU_EMIOS_2_MAX         (ICU_EMIOS_2_CH_0 + 31U)

/**@}*/
/**
* @{
* @brief      External Interrupt Channels
* @details    SIUL IRQ Channels
*/
#define ICU_IRQ_CH_0           (ICU_EMIOS_2_MAX + 1U)
...
#define ICU_IRQ_CH_16          (ICU_IRQ_CH_0 + 16U)
#define ICU_IRQ_CH_17          (ICU_IRQ_CH_0 + 17U)
#define ICU_IRQ_CH_18          (ICU_IRQ_CH_0 + 18U)
#define ICU_IRQ_CH_19          (ICU_IRQ_CH_0 + 19U)
#define ICU_IRQ_CH_20          (ICU_IRQ_CH_0 + 20U)
#define ICU_IRQ_CH_21          (ICU_IRQ_CH_0 + 21U)
#define ICU_IRQ_CH_22          (ICU_IRQ_CH_0 + 22U)
#define ICU_IRQ_CH_23          (ICU_IRQ_CH_0 + 23U)
#define ICU_IRQ_CH_24          (ICU_IRQ_CH_0 + 24U)
#define ICU_IRQ_CH_25          (ICU_IRQ_CH_0 + 25U)
#define ICU_IRQ_CH_26          (ICU_IRQ_CH_0 + 26U)
#define ICU_IRQ_CH_27          (ICU_IRQ_CH_0 + 27U)
#define ICU_IRQ_CH_28          (ICU_IRQ_CH_0 + 28U)
#define ICU_IRQ_CH_29          (ICU_IRQ_CH_0 + 29U)
#define ICU_IRQ_CH_30          (ICU_IRQ_CH_0 + 30U)
#define ICU_IRQ_CH_31          (ICU_IRQ_CH_0 + 31U)
/**@}*/

/**
* @{
* @brief      External Interrupt Channels
* @details    WKPU IRQ Channels
*/
#define ICU_WKPU_CH_0          (ICU_IRQ_CH_31 +  1U)
#define ICU_WKPU_CH_1          (ICU_WKPU_CH_0 +  1U)
#define ICU_WKPU_CH_2          (ICU_WKPU_CH_0 +  2U)
#define ICU_WKPU_CH_3          (ICU_WKPU_CH_0 +  3U)
#define ICU_WKPU_CH_4          (ICU_WKPU_CH_0 +  4U)
#define ICU_WKPU_CH_5          (ICU_WKPU_CH_0 +  5U)
#define ICU_WKPU_CH_6          (ICU_WKPU_CH_0 +  6U)
#define ICU_WKPU_CH_7          (ICU_WKPU_CH_0 +  7U)
#define ICU_WKPU_CH_8          (ICU_WKPU_CH_0 +  8U)
#define ICU_WKPU_CH_9          (ICU_WKPU_CH_0 +  9U)
#define ICU_WKPU_CH_10         (ICU_WKPU_CH_0 + 10U)
#define ICU_WKPU_CH_11         (ICU_WKPU_CH_0 + 11U)
#define ICU_WKPU_CH_12         (ICU_WKPU_CH_0 + 12U)
#define ICU_WKPU_CH_13         (ICU_WKPU_CH_0 + 13U)
#define ICU_WKPU_CH_14         (ICU_WKPU_CH_0 + 14U)
#define ICU_WKPU_CH_15         (ICU_WKPU_CH_0 + 15U)
#define ICU_WKPU_CH_16         (ICU_WKPU_CH_0 + 16U)
#define ICU_WKPU_CH_17         (ICU_WKPU_CH_0 + 17U)
#define ICU_WKPU_CH_18         (ICU_WKPU_CH_0 + 18U)
#define ICU_WKPU_CH_19         (ICU_WKPU_CH_0 + 19U)
#define ICU_WKPU_CH_20         (ICU_WKPU_CH_0 + 20U)
#define ICU_WKPU_CH_21         (ICU_WKPU_CH_0 + 21U)
#define ICU_WKPU_CH_22         (ICU_WKPU_CH_0 + 22U)
#define ICU_WKPU_CH_23         (ICU_WKPU_CH_0 + 23U)
#define ICU_WKPU_CH_24         (ICU_WKPU_CH_0 + 24U)
#define ICU_WKPU_CH_25         (ICU_WKPU_CH_0 + 25U)
#define ICU_WKPU_CH_26         (ICU_WKPU_CH_0 + 26U)
#define ICU_WKPU_CH_27         (ICU_WKPU_CH_0 + 27U)
#define ICU_WKPU_CH_28         (ICU_WKPU_CH_0 + 28U)
#define ICU_WKPU_CH_29         (ICU_WKPU_CH_0 + 29U)
#define ICU_WKPU_CH_30         (ICU_WKPU_CH_0 + 30U)
#define ICU_WKPU_CH_31         (ICU_WKPU_CH_0 + 31U)
/**@}*/
...
*             contiguous.
*/
#define ICU_MAX_EMIOS_CHANNELS      (ICU_IRQ_CH_0)
/**@}*/
...
*             contiguous.
*/
#define ICU_MAX_IRQ_CHANNELS        (ICU_IRQ_CH_31 + 1U)
/**@}*/


/**
* @{
* @brief      ICU_MAX_WKPU_CHANNELS - the maximum number of WKPU channels
* @details    Represents the maximum number of WKPU channels, not necessary all
*             are available for a specific derivative. If some channels are
*             missing for a derivative, the encoding of the channels will be not
*             contiguous.
*/
#define ICU_MAX_WKPU_CHANNELS        (ICU_WKPU_CH_31 + 1U)
/**@}*/
...
*             contiguous.
*/
#define ICU_MAX_HW_CHANNELS         (ICU_MAX_WKPU_CHANNELS)
/**@}*/
...
*/
#define ICU_EMIOS_CHANNELS(ch)      (ch)
/*
 * @violates @ref Icu_Ipw_Types_h_REF_2 Function-like macro defined
 * */
#define ICU_IRQ_CHANNELS(ch)        ((ch) - ICU_IRQ_CH_0)
/*
 * @violates @ref Icu_Ipw_Types_h_REF_2 Function-like macro defined
 * */
#define ICU_WKPU_CHANNELS(ch)    ((ch) - ICU_WKPU_CH_0)
/*
 * @violates @ref Icu_Ipw_Types_h_REF_2 Function-like macro defined
 * */
#define ICU_EMIOS_HW_CHANNEL(ch)      ((ch))
/*
 * @violates @ref Icu_Ipw_Types_h_REF_2 Function-like macro defined
 * */
#define ICU_IRQ_HW_CHANNEL(ch)     ((ch) + ICU_IRQ_CH_0)
/*
 * @violates @ref Icu_Ipw_Types_h_REF_2 Function-like macro defined
 * */
#define ICU_WKPU_HW_CHANNEL(ch)    ((ch) + ICU_WKPU_CH_0)
/**@}*/
 ...
 */
#define ICU_DMA_MAJORLOOP_COUNT    ((uint32)4U)
...
typedef struct 
{
    ...
    CONSTP2CONST(Icu_eMios_IpConfigType, ICU_CONST, ICU_APPL_CONST) peMiosIpConfig;
    /** @brief Pointer to the structure containing Siul2 configuration */
    CONSTP2CONST(Icu_Siul2_IpConfigType, ICU_CONST, ICU_APPL_CONST) pSiul2IpConfig;
    /** @brief Pointer to the structure containing WKPU configuration */
    CONSTP2CONST(Icu_Wkpu_IpConfigType,  ICU_CONST, ICU_APPL_CONST) pWkpuIpConfig;
