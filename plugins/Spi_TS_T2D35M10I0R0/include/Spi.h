...
typedef struct
{
    ...
    CONST(Spi_JobType, SPI_CONST) (* const pcJobIndexList)[];
...
typedef struct
{
    ...
    CONST(Spi_ChannelType, SPI_CONST) (* const pcChannelIndexList)[];
...
typedef struct
{
    ...
    CONST(Spi_ChannelConfigType, SPI_CONST) (* const pcChannelConfig)[];
    /**< @brief Pointer to Array of jobs defined in the configuration. */
    CONST(Spi_JobConfigType, SPI_CONST) (* const pcJobConfig)[];
    /**< @brief Pointer to Array of sequences defined in the configuration. */
    CONST(Spi_SequenceConfigType, SPI_CONST) (* const pcSequenceConfig)[];
    ...
    CONST(Spi_HWUnitConfigType, SPI_CONST) (* const pcHWUnitConfig)[];
    /** 
