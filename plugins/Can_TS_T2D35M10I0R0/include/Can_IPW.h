...
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
/* @violates @ref CAN_IPW_h_REF_5 MISRA 2004 Required Rule 19.4, C macros shall only expand to a braced initialiser,  a constant, a parenthesised expression */
        #define         Can_IPW_Init(Controller)                                Mcal_Trusted_Call(Can_FlexCan_Init,( Controller ))
#else
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
...
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
/* @violates @ref CAN_IPW_h_REF_5 MISRA 2004 Required Rule 19.4, C macros shall only expand to a braced initialiser,  a constant, a parenthesised expression */
        #define         Can_IPW_ResetController(Controller)                        Mcal_Trusted_Call_Return((uint32)Can_FlexCan_ResetController,(Controller))
#else
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
...
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
/* @violates @ref CAN_IPW_h_REF_5 MISRA 2004 Required Rule 19.4, C macros shall only expand to a braced initialiser,  a constant, a parenthesised expression */
        #define         Can_IPW_ChangeBaudrate(Controller)               Mcal_Trusted_Call_Return((uint32)Can_FlexCan_ChangeBaudrate,(Controller))
#else                                          
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
...
/* @violates @ref CAN_IPW_h_REF_5 MISRA 2004 Required Rule 19.4, C macros shall only expand to a braced initialiser,  a constant, a parenthesised expression */
        #define         Can_IPW_SetControllerMode(Controller, pCanControlerDescriptor, Transition, canif_notification_required) \
                         Mcal_Trusted_Call_Return((uint32)Can_FlexCan_SetControllerMode,((Controller), (pCanControlerDescriptor), (Transition), (canif_notification_required)))
#else
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
        #define         Can_IPW_SetControllerMode(Controller, pCanControlerDescriptor, Transition, canif_notification_required) \
...
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
    ...
    #endif /* (CAN_API_ENABLE_ABORT_MB == STD_ON) */
#if ((STD_ON == CAN_ENABLE_USER_MODE_SUPPORT) && (STD_ON == CAN_PUBLIC_ICOM_SUPPORT))
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
/* @violates @ref CAN_IPW_h_REF_5 MISRA 2004 Required Rule 19.4, C macros shall only expand to a braced initialiser,  a constant, a parenthesised expression */
    #define         Can_IPW_Write(Hth, PduInfo)                      Mcal_Trusted_Call_Return((uint32)Can_FlexCan_Write,((Hth), (PduInfo)) )
#else
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
...
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
/* @violates @ref CAN_IPW_h_REF_5 MISRA 2004 Required Rule 19.4, C macros shall only expand to a braced initialiser,  a constant, a parenthesised expression */
        #define         Can_IPW_SetIcomConfiguration( u8Controller, u8ConfigIcomIndex)         Mcal_Trusted_Call_Return((uint32)Can_FlexCan_SetIcomConfig, ( (u8Controller), (u8ConfigIcomIndex)))
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */     
/* @violates @ref CAN_IPW_h_REF_5 MISRA 2004 Required Rule 19.4, C macros shall only expand to a braced initialiser,  a constant, a parenthesised expression */
        #define         Can_IPW_DeactivateIcomConfiguration(u8Controller)                      Mcal_Trusted_Call_Return((uint32)Can_FlexCan_DeactivateIcom, (u8Controller))
    #else
/* @violates @ref CAN_IPW_h_REF_3 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
