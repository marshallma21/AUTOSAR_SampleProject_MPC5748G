        ...
        if ( FLEXCAN_MBCS_CODETX_U32 == (uint32)(REG_READ32( FLEXCAN_MB((u8HwOffset), (uint32)(u16MBGlobalIndex))) & (uint32)(FLEXCAN_MBCS_CODE_U32)))
        {
            ...
            if ( (NULL_PTR == PduInfo->sdu) )
            {
                ...
                if((boolean)TRUE == Can_pCurrentConfig->MBConfigContainer.pMessageBufferConfigsPtr[u16MBGlobalIndex].CanTriggerTransmitEnable)
                {
                    ...
                    /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                    /* @violates @ref Can_Flexcan_c_REF_6 Violates MISRA 2004 Required Rule 17.4,pointer arithmetic other than array indexing used */
                    PduInfoPtr.SduDataPtr = (uint8 *)((uint32)(CAN_GET_BASE_ADDRESS(u8HwOffset)) + (uint32)(FLEXCAN_MB_OFFSET(u16MBGlobalIndex)) + 0x08U);
                    ...
                    if(CAN_OK == CanIf_TriggerTransmit(TxPduId, &PduInfoPtr))
                    {
                        ...
                        if(((Can_pCurrentConfig->MBConfigContainer.pMessageBufferConfigsPtr) + u16MBGlobalIndex)->u8MBPayloadLength >= (uint32)PduInfoPtr.SduLength)
                        {
                        ...
                        #if (CAN_FD_MODE_ENABLE == STD_ON)
                            if(((uint8)PduInfoPtr.SduLength)<=(uint8)u8DataLengthMax[0])
                            {
                        #endif /* (CAN_FD_MODE_ENABLE == STD_ON) */
                            ...
                            else
                            {
                                for (u8DataLengthCount=1U; u8DataLengthCount<8U; u8DataLengthCount++)
                                {       
                                    if ((((uint8)PduInfoPtr.SduLength)<=(uint8)u8DataLengthMax[u8DataLengthCount])&&(((uint8)PduInfoPtr.SduLength)>=(uint8)u8DataLengthMin[u8DataLengthCount]))
                                    {
                                        u32MbConfig |= ((uint32)((uint32)8U+(uint32)u8DataLengthCount)<<((uint32)u8DataLengthOffset));
                                        u8RealDataLength = (uint8)u8DataLengthMax[u8DataLengthCount];
                                    }
...
==================================================================================================*/
        ...
        {
        #ifdef FLEXCAN_A_UNDER_REG_PROT
            #ifdef  FLEXCAN0_BASEADDR
                /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                SET_USER_ACCESS_ALLOWED(FLEXCAN0_BASEADDR);
            #endif
        #endif
        #ifdef FLEXCAN_B_UNDER_REG_PROT
            #ifdef  FLEXCAN1_BASEADDR
                /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                SET_USER_ACCESS_ALLOWED(FLEXCAN1_BASEADDR);
            #endif
        #endif
        #ifdef FLEXCAN_C_UNDER_REG_PROT
            #ifdef  FLEXCAN2_BASEADDR
                /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                SET_USER_ACCESS_ALLOWED(FLEXCAN2_BASEADDR);
            #endif
        #endif
        #ifdef FLEXCAN_D_UNDER_REG_PROT
            #ifdef  FLEXCAN3_BASEADDR
                /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                SET_USER_ACCESS_ALLOWED(FLEXCAN3_BASEADDR);
            #endif
        #endif
        #ifdef FLEXCAN_E_UNDER_REG_PROT
            #ifdef  FLEXCAN4_BASEADDR
                /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                SET_USER_ACCESS_ALLOWED(FLEXCAN4_BASEADDR);
            #endif
        #endif
        #ifdef FLEXCAN_F_UNDER_REG_PROT
            #ifdef  FLEXCAN5_BASEADDR
                /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                SET_USER_ACCESS_ALLOWED(FLEXCAN5_BASEADDR);
            #endif
        #endif
        #ifdef FLEXCAN_G_UNDER_REG_PROT
            #ifdef  FLEXCAN6_BASEADDR
                /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                SET_USER_ACCESS_ALLOWED(FLEXCAN6_BASEADDR);
            #endif
        #endif
        #ifdef FLEXCAN_H_UNDER_REG_PROT
            #ifdef  FLEXCAN7_BASEADDR
                /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                SET_USER_ACCESS_ALLOWED(FLEXCAN7_BASEADDR);
            #endif
        #endif
        }
    #endif /* CAN_HAS_CONTROLLER_UNDER_REG_PROT */
...
*/            
        ...
        u32TempAddr = 0x0080U;
        while(u32TempAddr < 0x0680U)
        {
            /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
            /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
            REG_WRITE32( CAN_GET_BASE_ADDRESS(u8HwOffset) + u32TempAddr, (uint32)0U);
                                                   ...
                                                   P2CONST(Can_PduType, AUTOMATIC, CAN_APPL_CONST) PduInfo )
{
    ...
    else
    {
        ...
        /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
        if( ((uint32)FLEXCAN_PNET_ENABLE_U32) == (((uint32)REG_READ32 (FLEXCAN_MCR(u8HwOffset))) & ((uint32)FLEXCAN_PNET_ENABLE_U32)))
        {
            eReturnValue = CAN_NOT_OK;
        }
        if (CAN_NOT_OK!=eReturnValue)
...
FUNC(Std_ReturnType, CAN_CODE) Can_FlexCan_SetIcomConfig( VAR(uint8, AUTOMATIC) u8Controller, VAR(uint8, AUTOMATIC) u8ConfigIcomIndex )
{
    ...
    if ((uint32)0U < u32TimeoutCount)
    {
        ...
        u32RegisterValue = (uint32)(CanIcomRxMessageConfig->CanIcomMissingMessageTimerValue);
        /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
        REG_WRITE32(FLEXCAN_CAN_CTRL2_PN(u8HwOffset), (uint32)u32RegisterValue);
    #endif
        ...
        u32RegisterValue = (uint32)(CanIcomRxMessageSignalConfig->CanIcomSignalValue & (uint32)0xFFFFFFFFU);
        /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
        REG_WRITE32(FLEXCAN_CAN_PL1_HI(u8HwOffset), u32RegisterValue);
        /* Write value for CAN_PL1_LO register */
        u32RegisterValue = (uint32)(CanIcomRxMessageSignalConfig->CanIcomSignalValue >> 32U);
        /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
        REG_WRITE32(FLEXCAN_CAN_PL1_LO(u8HwOffset), u32RegisterValue);
    
        /* Write value for CAN_PL2_PLMASK_HI register */
        u32RegisterValue = (uint32)(CanIcomRxMessageSignalConfig->CanIcomSignalMask & (uint32)0xFFFFFFFFU);
        /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
        REG_WRITE32(FLEXCAN_CAN_PL2_PLMASK_HI(u8HwOffset), u32RegisterValue);
        /* Write value for CAN_PL2_PLMASK_LO register */
        u32RegisterValue = (uint32)(CanIcomRxMessageSignalConfig->CanIcomSignalMask >> 32U);
        /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
        REG_WRITE32(FLEXCAN_CAN_PL2_PLMASK_LO(u8HwOffset), u32RegisterValue);
        u32RegisterValue = 0U;
    ...
    #if (CAN_PRETENDED_SIGNAL_VALUE==STD_ON)
...
{
    VAR(uint8, AUTOMATIC) u8HwOffset = 0U;
    VAR(uint32, AUTOMATIC) can_numbermb = 0U;
    VAR(uint8, AUTOMATIC) u8CanMbData[8U] = {0U};
    VAR(uint8, AUTOMATIC) u8DatabyteIndex = 0U;
    /* Identifies the HRH and its corresponding CAN Con-troller. */
    VAR(Can_HwType, AUTOMATIC) Mailbox;
    /* Pointer to the received L-PDU. */
    ...
    if(FLEXCAN_WU_MTC_WUMF_MSK_U32 ==((uint32)REG_READ32(FLEXCAN_CAN_WU_MTC(u8HwOffset)) & FLEXCAN_WU_MTC_WUMF_MSK_U32))
    {
        ...
        /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
        can_numbermb = (uint32)(((uint32)REG_READ32(FLEXCAN_CAN_CTRL1_PN(u8HwOffset)) & (uint32)FLEXCAN_CTRL1_PN_NMATCH_U32) >> 8U);
        if (4U>=can_numbermb)
        {
            can_numbermb = can_numbermb - 1U;
        }
        else
        {
            can_numbermb = 3U;
        ...
        /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
        if (FLEXCAN_CAN_WMB_CS_IDE_U32 == (uint32)(REG_READ32(FLEXCAN_CAN_WMB_CS(u8HwOffset, (can_numbermb))) & FLEXCAN_CAN_WMB_CS_IDE_U32))
        {
            /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
            /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
            Mailbox.CanId = (Can_IdType)(REG_READ32(FLEXCAN_CAN_WMB_ID(u8HwOffset, (can_numbermb))) & FLEXCAN_CAN_WMB_ID_IDMB_U32);
        }
        else
        {
            /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
            /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
            Mailbox.CanId = (Can_IdType)((REG_READ32(FLEXCAN_CAN_WMB_ID(u8HwOffset, (can_numbermb))) & FLEXCAN_CAN_WMB_ID_IDMB_U32) >> FLEXCAN_STANDARD_ID_SHIFT_U32);
        }
        /* ID of the corresponding Hardware Object Range */
        Mailbox.Hoh = (Can_HwHandleType)can_numbermb;
        /* ControllerId provided by CanIf clearly identify the corresponding controller */
        Mailbox.ControllerId = u8controller;
        /* length of the SDU in bytes */
        /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
        PduInfoPtr.SduLength = (uint32)((uint32)(REG_READ32(FLEXCAN_CAN_WMB_CS(u8HwOffset, (can_numbermb))) & FLEXCAN_CAN_WMB_CS_DLC_U32) >> 16U);
        ...
        for ( u8DatabyteIndex = (uint8)0U; u8DatabyteIndex < (uint8)PduInfoPtr.SduLength; u8DatabyteIndex++)
        {
            switch (u8DatabyteIndex)
            {
                case (0U):
                    /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                    u8CanMbData[u8DatabyteIndex] = (uint8)((((uint32)REG_READ32(FLEXCAN_CAN_WMB_D03(u8HwOffset, (can_numbermb)))) >> 24U)& (uint32)0xFF);
                    break;
                case (1U):
                    /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                    u8CanMbData[u8DatabyteIndex] = (uint8)((((uint32)REG_READ32(FLEXCAN_CAN_WMB_D03(u8HwOffset, (can_numbermb)))) >> 16U)& (uint32)0xFF);
                    break;
                case (2U):
                    /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                    u8CanMbData[u8DatabyteIndex] = (uint8)((((uint32)REG_READ32(FLEXCAN_CAN_WMB_D03(u8HwOffset, (can_numbermb)))) >> 8U)& (uint32)0xFF);
                    break;
                case (3U):
                    /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                    u8CanMbData[u8DatabyteIndex] = (uint8)((((uint32)REG_READ32(FLEXCAN_CAN_WMB_D03(u8HwOffset, (can_numbermb)))) >> 0U) & (uint32)0xFF);
                    break;
                case (4U):
                    /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                    u8CanMbData[u8DatabyteIndex] = (uint8)(((uint32)REG_READ32(FLEXCAN_CAN_WMB_D47(u8HwOffset, (can_numbermb))) >> 24U) & (uint32)0xFF);
                    break;
                case (5U):
                    /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                    u8CanMbData[u8DatabyteIndex] = (uint8)(((uint32)REG_READ32(FLEXCAN_CAN_WMB_D47(u8HwOffset, (can_numbermb))) >> 16U) & (uint32)0xFF);
                    break;
                case (6U):
                    /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                    u8CanMbData[u8DatabyteIndex] = (uint8)(((uint32)REG_READ32(FLEXCAN_CAN_WMB_D47(u8HwOffset, (can_numbermb))) >> 8U) & (uint32)0xFF);
                    break;
                case (7U):
                    /* @violates @ref Can_Flexcan_c_REF_2 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Can_Flexcan_c_REF_9 Violates MISRA 2004 Advisory Rule 11.3, A cast should not be performed */
                    u8CanMbData[u8DatabyteIndex] = (uint8)(((uint32)REG_READ32(FLEXCAN_CAN_WMB_D47(u8HwOffset, (can_numbermb))) >> 0U) & (uint32)0xFF);
                    break;
                default:
                    break;
            }
