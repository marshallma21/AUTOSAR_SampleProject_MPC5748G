...
#define LIN_SW_PATCH_VERSION_IPW_C             0
...
#if (LIN_IPW_VENDOR_ID_C != LIN_VENDOR_ID_FLEX)
    #error "Lin_IPW.c and Lin_Linflex.h have different vendor ids"
#endif
...
#if ((LIN_AR_RELEASE_MAJOR_VERSION_IPW_C    != LIN_AR_RELEASE_MAJOR_VERSION_FLEX) || \
     (LIN_AR_RELEASE_MINOR_VERSION_IPW_C    != LIN_AR_RELEASE_MINOR_VERSION_FLEX) || \
     (LIN_AR_RELEASE_REVISION_VERSION_IPW_C != LIN_AR_RELEASE_REVISION_VERSION_FLEX))
    #error "AutoSar Version Numbers of Lin_Ipw.c and Lin_Linflex.h are different"
#endif
/* Check if current file and Lin_Linflex header file are of the same Software version */
#if ((LIN_SW_MAJOR_VERSION_IPW_C != LIN_SW_MAJOR_VERSION_FLEX) || \
     (LIN_SW_MINOR_VERSION_IPW_C != LIN_SW_MINOR_VERSION_FLEX) || \
     (LIN_SW_PATCH_VERSION_IPW_C != LIN_SW_PATCH_VERSION_FLEX))
    #error "Software Version Numbers of Lin_Ipw.c and Lin_Linflex.h are different"
#endif
/*==================================================================================================
...
{
    Lin_Linflex_WakeupInternal(u8Channel);
}
