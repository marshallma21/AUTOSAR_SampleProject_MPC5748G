...
* identifiers.
*
* @section Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_c_REF_1
...
*
* @section Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_c_REF_2
...
*
* @section Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_c_REF_3
...
*
* @section Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_c_REF_6
...
==================================================================================================*/
/**
* @file           Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!].c
*/
#define LIN_VENDOR_ID_PBCFG[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_C                      43
/*
* @violates @ref Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_c_REF_3 The compiler/linker shall be checked to
...
#define LIN_SW_PATCH_VERSION_PBCFG[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_C               0
...
/* Check if current file and LIN header file are of the same vendor */
    ...
    #error "Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!].c and Lin_Cfg.h have different vendor ids"
#endif
/* Check if current file and LIN header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!].c and Lin_Cfg.h are different"
#endif
/* Check if current file and LIN header file are of the same Software version */
    ...
    #error "Software Version Numbers of Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!].c and Lin_Cfg.h are different"
#endif
        ...
        #error "AutoSar Version Numbers of Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!].c and Std_Types.h are different"
    #endif
        ...
        /* Check if current file and Dem.h header file are of the same Autosar version */
            ...
            #error "AutoSar Version Numbers of Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!].c and Dem.h are different"
        #endif
    #endif /* (LIN_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF) */
#endif
...
/**
* @violates @ref Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_c_REF_1 #include statements in a file should
...
*/
/*
* @violates @ref Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_c_REF_6 All declarations and definitions of objects or functions at
...
[!NOCODE!][!//
    [!IF "$DualClockEnabled = 'true'"!]
        [!IF "node:exists(node:value(LinClockRef_Alternate))"!]
            [!VAR "linBaudrate" = "LinChannelBaudRate"!]
            [!SELECT "node:ref(LinClockRef_Alternate)"!]
            [!INCLUDE "Lin_BaudRate_Comp.m"!][!//
            [!ENDSELECT!][!//
            [!CODE!]
            [!"$LINIBRR_LINFBRR"!]U,    /* Alternate Baudrate [!"LinChannelBaudRate"!] */
            [!ENDCODE!]
        [!ELSE!]
            [!CODE!]
            [!"$LINIBRR_LINFBRR"!]U,    /* LIN is not enable Alternate Mode, Set Alternate Baudrate is the same configuration as Normal Mode */
            [!ENDCODE!]
        [!ENDIF!][!//
    [!ENDIF!]
[!CODE!]
...
* @violates @ref Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_c_REF_1 #include statements in a file should
*                only be preceded by other preprocessor directives or comments.
* @violates @ref Lin_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_c_REF_2 Precautions shall be taken in
