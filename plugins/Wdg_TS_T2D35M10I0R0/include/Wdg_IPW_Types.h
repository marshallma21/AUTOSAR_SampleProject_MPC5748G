...
#if (WDG_IPW_TYPES_VENDOR_ID!= WDG_SWT_TYPES_VENDOR_ID)
    #error "Wdg_IPW_Types.h and Wdg_Swt_Types.h have different vendor ids"
#endif

/* Check if Wdg_IPW_Types file and Wdg_Swt_Types.h header file are of the same Autosar version */
#if ((WDG_IPW_TYPES_AR_RELEASE_MAJOR_VERSION != WDG_SWT_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (WDG_IPW_TYPES_AR_RELEASE_MINOR_VERSION != WDG_SWT_TYPES_AR_RELEASE_MINOR_VERSION ) || \
     (WDG_IPW_TYPES_AR_RELEASE_REVISION_VERSION  != WDG_SWT_TYPES_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Wdg_IPW_Types.h and Wdg_Swt_Types.h are different"
#endif

/* Check if Wdg_IPW_Types file and Wdg_Swt_Types.h header file are of the same Software version */
#if ((WDG_IPW_TYPES_SW_MAJOR_VERSION != WDG_SWT_TYPES_SW_MAJOR_VERSION ) || \
     (WDG_IPW_TYPES_SW_MINOR_VERSION != WDG_SWT_TYPES_SW_MINOR_VERSION ) || \
     (WDG_IPW_TYPES_SW_PATCH_VERSION != WDG_SWT_TYPES_SW_PATCH_VERSION ))
    #error "Software Version Numbers of Wdg_IPW_Types.h and Wdg_Swt_Types.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
...
#define Wdg_IPW_ConfigType Wdg_Swt_ConfigType
