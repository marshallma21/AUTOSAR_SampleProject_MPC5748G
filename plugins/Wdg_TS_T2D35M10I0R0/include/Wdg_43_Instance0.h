...
/** @violates @ref Wdg_43_Instance0_H_REF_2 MISRA 2004 Rule 1.4 */
/** @violates @ref Wdg_43_Instance0_H_REF_3 MISRA 2004 Rule 5.1 */
#define WDG_43_INSTANCE0_AR_RELEASE_MAJOR_VERSION     4
/** @violates @ref Wdg_43_Instance0_H_REF_2 MISRA 2004 Rule 1.4 */
/** @violates @ref Wdg_43_Instance0_H_REF_3 MISRA 2004 Rule 5.1 */
#define WDG_43_INSTANCE0_AR_RELEASE_MINOR_VERSION     2
/** @violates @ref Wdg_43_Instance0_H_REF_2 MISRA 2004 Rule 1.4 */
/** @violates @ref Wdg_43_Instance0_H_REF_3 MISRA 2004 Rule 5.1 */
...
/* Check if current file and WDG configuration header file are of the same vendor */
    ...
    #error "Wdg_43_Instance0.h and Wdg_Channel.h have different vendor ids"
#endif

/* Check if current file and WDG channel header file are of the same Autosar version */
#if ((WDG_43_INSTANCE0_AR_RELEASE_MAJOR_VERSION    != WDG_CHANNEL_AR_RELEASE_MAJOR_VERSION) || \
     (WDG_43_INSTANCE0_AR_RELEASE_MINOR_VERSION    != WDG_CHANNEL_AR_RELEASE_MINOR_VERSION) || \
     (WDG_AR_RELEASE_REVISION_VERSION != WDG_CHANNEL_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Wdg_43_Instance0.h and Wdg_Channel.h are different"
#endif
/* Check if current file and WDG configuration header file are of the same software version */
    ...
    #error "Software Version Numbers of Wdg_43_Instance0.h and Wdg_Channel.h are different"
#endif
...
* @violates @ref Wdg_43_Instance0_H_REF_1 MISRA 2004 Required Rule 19.15 precautions to prevent the contents
