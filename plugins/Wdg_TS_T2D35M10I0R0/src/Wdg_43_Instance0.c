...
*
* @section Wdg_43_Instance0_C_REF_1
*          Violates MISRA 2004 Required Rule 19.15, Precautions shall be taken in order to
*          prevent the contents of a header file being included twice. All header files are
*          protected against multiple inclusions.
* @section Wdg_43_Instance0_C_REF_2
*          Violates MISRA 2004 Required Rule 1.4, The compiler/linker shall be checked to ensure
*          that 31 character significance and case sensitivity are supported for external identifiers.
*          The defines are validated.
* @section Wdg_43_Instance0_C_REF_3
...
* @section Wdg_43_Instance0_C_REF_4
...
* @section Wdg_43_Instance0_C_REF_5
...
/** @violates @ref Wdg_43_Instance0_C_REF_2 MISRA 2004 Rule 1.4 */
/** @violates @ref Wdg_43_Instance0_C_REF_3 MISRA 2004 Rule 5.1 */
...
/* Check if current file and WDG configuration header file are of the same vendor */
    ...
    #error "Wdg_43_Instance0.c and Wdg_Channel.h have different vendor ids"
#endif
...
/* Check if current file and WDG configuration header file are of the same software version */
    ...
    #error "Software Version Numbers of Wdg_43_Instance0.c and Wdg_Channel.h are different"
#endif

/* Check if current file and WDG header file are of the same vendor */
#if (WDG_VENDOR_ID_C != WDG_VENDOR_ID)
    #error "Wdg_43_Instance0.c and Wdg_43_Instance0.h have different vendor ids"
#endif

/* Check if current file and WDG header file are of the same Autosar version */
#if ((WDG_AR_RELEASE_MAJOR_VERSION_C   != WDG_43_INSTANCE0_AR_RELEASE_MAJOR_VERSION) || \
     (WDG_AR_RELEASE_MINOR_VERSION_C     != WDG_43_INSTANCE0_AR_RELEASE_MINOR_VERSION) || \
     (WDG_AR_RELEASE_REVISION_VERSION_C != WDG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Wdg_43_Instance0.c and Wdg_43_Instance0.h are different"
#endif
...
/* Check if current file and WDG header file are of the same software version */
    ...
    #error "Software Version Numbers of Wdg_43_Instance0.c and Wdg_43_Instance0.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
...
* @violates @ref Wdg_43_Instance0_C_REF_1 MISRA 2004 Required Rule 19.15 precautions to prevent the contents
...
*
* @api
* @violates @ref Wdg_43_Instance0_C_REF_5 MISRA 2004 Required Rule 8.10, All declarations and definitions of objects or
* functions at file scope shall have internal linkage unless external linkage is required. */
FUNC(void, WDG_CODE) Wdg_43_Instance0_Init(P2CONST(Wdg_ConfigType, AUTOMATIC, WDG_APPL_CONST) pConfigPtr)
{
...
* @violates @ref Wdg_43_Instance0_C_REF_5 MISRA 2004 Required Rule 8.10, All declarations and definitions of objects or
* functions at file scope shall have internal linkage unless external linkage is required. */
FUNC(Std_ReturnType, WDG_CODE) Wdg_43_Instance0_SetMode(WdgIf_ModeType Mode)
{
 ...
 * @violates @ref Wdg_43_Instance0_C_REF_5 MISRA 2004 Required Rule 8.10, All declarations and definitions of objects or
 * functions at file scope shall have internal linkage unless external linkage is required. */
FUNC(void, WDG_CODE) Wdg_43_Instance0_SetTriggerCondition(uint16 u16Timeout)
{
...
* @violates @ref Wdg_43_Instance0_C_REF_5 MISRA 2004 Required Rule 8.10, All declarations and definitions of objects or
* functions at file scope shall have internal linkage unless external linkage is required. */
FUNC(void, WDG_CODE) Wdg_43_Instance0_GetVersionInfo(P2VAR(Std_VersionInfoType, AUTOMATIC, WDG_APPL_DATA) pVersioninfo)
{
...
/**
* @brief Include Memory mapping specification
* @violates @ref Wdg_43_Instance0_C_REF_1 MISRA 2004 Required Rule 19.15
* @violates @ref Wdg_43_Instance0_C_REF_4 MISRA 2004 Rule 19.1
*/
#include "Wdg_MemMap.h"
