...
*                                      DEFINES AND MACROS
==================================================================================================*/
[!CALL "WdgCheckCbkNotification","SwtInstance"="'SWT0'"!]
[!CALL "WdgCheckCbkNotification","SwtInstance"="'SWT1'"!]
[!CALL "WdgCheckCbkNotification","SwtInstance"="'SWT2'"!]

[!CALL "WdgInstanceMacro","SwtInstance" = "'SWT0'"!]
[!CALL "WdgInstanceMacro","SwtInstance" = "'SWT1'"!]
[!CALL "WdgInstanceMacro","SwtInstance" = "'SWT2'"!]
...
*/
#define WdgConf_WdgGeneral_[!"node:name(WdgGeneral/WdgIndex1)"!]_U8 ((uint8)[!"num:i(WdgGeneral/WdgIndex1)"!])

/**
* @brief  This variable will indicate the index of instance 2
*/
#define WdgConf_WdgGeneral_[!"node:name(WdgGeneral/WdgIndex2)"!]_U8 ((uint8)[!"num:i(WdgGeneral/WdgIndex2)"!])
...
[!CALL "WdgIsr","WdgSwtInstance" = "'SWT0'"!]
[!CALL "WdgIsr","WdgSwtInstance" = "'SWT1'"!]
[!CALL "WdgIsr","WdgSwtInstance" = "'SWT2'"!]
