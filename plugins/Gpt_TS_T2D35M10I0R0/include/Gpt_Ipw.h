...
FUNC (void, GPT_CODE) Gpt_Ipw_SetClockMode(P2CONST(Gpt_HwChannelConfigType, AUTOMATIC,GPT_APPL_CONST) pHwChannelConfig,
...
FUNC (void, GPT_CODE) Gpt_Ipw_EnableCounter
(
