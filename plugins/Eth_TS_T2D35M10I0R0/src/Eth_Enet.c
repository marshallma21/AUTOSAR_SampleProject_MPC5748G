...
static FUNC(void, ETH_CODE)Eth_Enet_ClearRxBuffer (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8Buf)
{
    ...
    Mcl_CacheClearMultiLines(MCL_LMEM_CACHE_PS, ETH_CFG_TXBDSTARTADDRESS(u8CtrlIdx), ETH_TX_BUF_MEM_SIZE);
    #endif
  #endif
#endif
                                                ...
                                                )
{
  ...
  #if STD_ON == MCAL_CACHE_RUNTIME_MNGMNT
    #if (MCL_SYNCRONIZE_CACHE == STD_ON)
    Mcl_CacheFlushMultiLines(MCL_LMEM_CACHE_PS, ETH_CFG_TXBDSTARTADDRESS(u8CtrlIdx), ETH_TX_BUF_MEM_SIZE);
    #endif
  #endif
#endif
...
*/
FUNC(boolean, ETH_CODE) Eth_Enet_IsTxBufLockedBT (CONST(uint8, AUTOMATIC) u8CtrlIdx, CONST(uint8, AUTOMATIC) u8Buf)
{
...
if (1522U > u16BufLength)
{
  ...
  #if STD_ON == MCAL_CACHE_RUNTIME_MNGMNT
    #if (MCL_SYNCRONIZE_CACHE == STD_ON)
    Mcl_CacheFlushMultiLines(MCL_LMEM_CACHE_PS, ETH_CFG_RXBDSTARTADDRESS(u8CtrlIdx), ETH_RX_BUF_MEM_SIZE);
    #endif
  #endif
#endif
}
...
#ifdef ETH_ENABLE_USER_MODE_SUPPORT
#if (STD_ON == ETH_ENABLE_USER_MODE_SUPPORT)
#ifdef ETH_HAS_CONTROLLER_UNDER_REG_PROT  
/** 
...
FUNC(void, ETH_CODE) Eth_Enet_SetUserAccessAllowed(void)
{
   /* Set UAA bit in REG_PROT register */
    ...
    /** @violates @ref Eth_Enet_c_REF_2 MISRA rule 11.3
        @violates @ref Eth_Enet_c_REF_7 MISRA rule 11.1
    */
       SET_USER_ACCESS_ALLOWED(ENET_0_BASEADDR);
   #endif
   #ifdef ENET_1_UNDER_REG_PROT
    /** @violates @ref Eth_Enet_c_REF_2 MISRA rule 11.3
        @violates @ref Eth_Enet_c_REF_7 MISRA rule 11.1
    */
      SET_USER_ACCESS_ALLOWED(ENET_1_BASEADDR);
   #endif
}
                                                         ...
                                                         )
{
  ...
  #if STD_ON == MCAL_CACHE_RUNTIME_MNGMNT
    #if (MCL_SYNCRONIZE_CACHE == STD_ON)
    Mcl_CacheClearMultiLines(MCL_LMEM_CACHE_PS, ETH_CFG_RXBDSTARTADDRESS(u8CtrlIdx), ETH_RX_BUF_MEM_SIZE);
    #endif
  #endif
#endif
    do
