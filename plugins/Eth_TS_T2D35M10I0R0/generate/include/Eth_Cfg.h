...
*/!]
  ...
  [!INCLUDE "Eth_GetRegisterValues.m"!][!// Calculates register values from configuration paremeters
...
#define ETH_SW_PATCH_VERSION_CFG             0
...
*/
        #define ETH_HAS_CONTROLLER_UNDER_REG_PROT
    [!ENDIF!]
