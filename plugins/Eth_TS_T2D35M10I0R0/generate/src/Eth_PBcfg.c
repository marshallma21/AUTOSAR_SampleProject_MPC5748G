...
static CONST(Eth_CtrlCfgType, ETH_APPL_CONST) [!"$ConfigSetName"!]_[!"name(.)"!] =
{
  ...
  [!ENDIF!][!//
    ...
    { [!IF "$EthDemEAccessEnabled     = 'true'"!](VAR(uint32, AUTOMATIC))STD_ON[!ELSE!](VAR(uint32, AUTOMATIC))STD_OFF[!ENDIF!], [!"$EthDemEAccessEventId"!] },
    { [!IF "$EthDemFrameLostEnabled   = 'true'"!](VAR(uint32, AUTOMATIC))STD_ON[!ELSE!](VAR(uint32, AUTOMATIC))STD_OFF[!ENDIF!], [!"$EthDemFrameLostEventId"!] },
    { [!IF "$EthDemECRCEnabled        = 'true'"!](VAR(uint32, AUTOMATIC))STD_ON[!ELSE!](VAR(uint32, AUTOMATIC))STD_OFF[!ENDIF!], [!"$EthDemECRCEventId"!] },
    { [!IF "$EthDemEUnderSizeEnabled  = 'true'"!](VAR(uint32, AUTOMATIC))STD_ON[!ELSE!](VAR(uint32, AUTOMATIC))STD_OFF[!ENDIF!], [!"$EthDemEUnderSizeEventId"!] },
    { [!IF "$EthDemEOverSizeEnabled   = 'true'"!](VAR(uint32, AUTOMATIC))STD_ON[!ELSE!](VAR(uint32, AUTOMATIC))STD_OFF[!ENDIF!], [!"$EthDemEOverSizeEventId"!] },
    { [!IF "$EthDemEAlignmentEnabled  = 'true'"!](VAR(uint32, AUTOMATIC))STD_ON[!ELSE!](VAR(uint32, AUTOMATIC))STD_OFF[!ENDIF!], [!"$EthDemEAlignmentEventId"!] },
    { [!IF "$EthDemE1ColEnabled       = 'true'"!](VAR(uint32, AUTOMATIC))STD_ON[!ELSE!](VAR(uint32, AUTOMATIC))STD_OFF[!ENDIF!], [!"$EthDemE1ColEventId"!] },
    { [!IF "$EthDemEMColEnabled       = 'true'"!](VAR(uint32, AUTOMATIC))STD_ON[!ELSE!](VAR(uint32, AUTOMATIC))STD_OFF[!ENDIF!], [!"$EthDemEMColEventId"!] },
    { [!IF "$EthDemELColEnabled       = 'true'"!](VAR(uint32, AUTOMATIC))STD_ON[!ELSE!](VAR(uint32, AUTOMATIC))STD_OFF[!ENDIF!], [!"$EthDemELColEventId"!] },  
