        ...
        [!VAR "ETH_BDSIZE" = "num:i(32)"!]
            ...
            [!LOOP "EthCtrlConfig/*"!] [!// Loop over the controller config
                [!SELECT "EthVendorSpecific"!][!// Container is selected for simpler access to children
                  [!IF "num:i(EthInterPacketGap)<8"!][!// Check it EthInterPacketGap is in valid interval 8-27
                  ...
                  [!ENDIF!]
                  [!IF "num:i(EthInterPacketGap)>27"!][!// Check it EthInterPacketGap is in valid interval 8-27B
                    [!ERROR!]ETH module configuration error: EthConfigSet/[!"name(..)"!]/EthVendorSpecific/EthInterPacketGap value must less or equal to 27B[!ENDERROR!]
                  [!ENDIF!]
