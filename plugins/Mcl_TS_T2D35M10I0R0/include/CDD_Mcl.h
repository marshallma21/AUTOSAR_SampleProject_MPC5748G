...
/**
* @brief   API Mcl_DeInit service is not allowed because a CRS register of AXBS is locked
* 
*/
#define MCL_E_CRS_AXBS_LOCKED_U8            ((uint8)0x16U)
...
typedef struct 
{
    ...
    /** @brief Pointer to the Crossbar configuration */
    P2CONST(Mcl_CrossbarConfigType, MCL_VAR, MCL_APPL_CONST)             pMclCrossbarConfig;
#endif
} Mcl_ConfigType;
