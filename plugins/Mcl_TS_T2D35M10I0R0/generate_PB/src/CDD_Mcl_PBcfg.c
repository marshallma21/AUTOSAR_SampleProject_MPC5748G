...
#define MCL_PBCFG[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_PATCH_VERSION_C              0
...
[!IF "../../MclGeneral/MclEnableCrossbarSwitch"!]
[!VAR "EnableInitAXBS_MGPCR"              = "num:i(ecu:get('Mcl.Crossbar.EnableInitAXBS_MGPCR'))"!][!//
[!VAR "PRSIsReadOnly"                     = "num:i(ecu:get('Mcl.Crossbar.PRS.IsReadOnly'))"!][!//
[!NOCODE!]/*********************** Configuration for the crossbar switch ******************/[!ENDNOCODE!][!//

[!CALL "AxbsConfigMaster","AxbsConfigType" = "''"!]
[!NOCODE!]/*********************** Configuration for the crossbar switch ******************/[!ENDNOCODE!][!//
/**
...
#define MCL_CROSSBAR_CONF_PORTS[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]  [!"$crossbarPortCount"!]
...
* @details          
*/
static CONST(Mcl_CrossbarConfigType, MCL_CONST)  Mcl_CrossbarSwitchConfig[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
    {
        /** @brief Number of configured logical ports. */
        [!"$crossbarPortCount"!]U,
[!IF "$EnableInitAXBS_MGPCR = 1"!]
        /** @brief The number of Master ports. */
        [!"$MastercrossbarPortCount"!]U,
[!ENDIF!]
        /** @brief Pointer to the structure containing slave port configuration */
        &Mcl_Crossbar_SlavePortConfig[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]
[!IF "$EnableInitAXBS_MGPCR = 1"!]
        ,
        /** @brief Pointer to the structure containing master port configuration */
        &Mcl_Crossbar_MasterPortConfig[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]
[!ENDIF!]
    };
[!ENDIF!]
...
[!IF "../../MclGeneral/MclEnableCrossbarSwitch"!][!//
       [!IF "$comma = 1"!]
        ,
        [!ENDIF!]
        &Mcl_CrossbarSwitchConfig[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]
[!ENDIF!][!//MclEnableCrossbarSwitch
    };
[!ENDLOOP!]
