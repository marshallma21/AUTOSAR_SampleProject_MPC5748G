...
/* The number of channels in EMIOS_2 */
#define GPT_EMIOS_2_NUM_CHANNEL_U8   (6U)
            
/* The maximum number of channels in EMIOS */
#define GPT_EMIOS_CHAN_NUM_U8         (96U)
